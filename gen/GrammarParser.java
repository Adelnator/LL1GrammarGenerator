...
public class GrammarParser extends Parser {
	...
	public static final int
		T__0=1, T__1=2, T__2=3, T__3=4, T__4=5, T__5=6, T__6=7, SYMBOL=8;
	public static final int
	...
	private static final String[] _LITERAL_NAMES = {
		null, "'grammar'", "'$'", "'@header'", "':'", "'#'", "'->'", "'skip'"
	};
	private static final String[] _SYMBOLIC_NAMES = {
		null, null, null, null, null, null, null, null, "SYMBOL"
	};
	...
	public final GramContext gram() throws RecognitionException {
		...
		try {
			...
			match(T__0);
			setState(17);
			((GramContext)_localctx).name = name();
			setState(18);
			match(T__1);
			setState(32);
			...
			case 1:
				...
				do {
					...
					case 1+1:
						...
						{
						setState(19);
						((GramContext)_localctx).SYMBOL = match(SYMBOL);
						}
						}
						break;
					default:
	...
	public final TermContext term() throws RecognitionException {
		...
		try {
			...
			{
			setState(54);
			((TermContext)_localctx).name = name();
			setState(55);
			match(T__3);
			setState(56);
			((TermContext)_localctx).termrightpart = termrightpart();
			setState(57);
			match(T__1);
	...
	public static class TermrightpartContext extends ParserRuleContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof GrammarVisitor ) return ((GrammarVisitor<? extends T>)visitor).visitTermrightpart(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public final TermrightpartContext termrightpart() throws RecognitionException {
		...
		try {
			...
			do {
				...
				{
				setState(60);
				((TermrightpartContext)_localctx).SYMBOL = match(SYMBOL);
	...
	public final NontermContext nonterm() throws RecognitionException {
		...
		try {
			...
			{
			setState(68);
			((NontermContext)_localctx).name = name();
			setState(73); 
			_errHandler.sync(this);
			_la = _input.LA(1);
			do {
				...
				match(T__4);
				setState(70);
				((NontermContext)_localctx).nontermrightpart = nontermrightpart();
	...
	public static class NontermrightpartContext extends ParserRuleContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof GrammarVisitor ) return ((GrammarVisitor<? extends T>)visitor).visitNontermrightpart(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public final NontermrightpartContext nontermrightpart() throws RecognitionException {
		...
		try {
			...
			do {
				...
				{
				setState(80);
				((NontermrightpartContext)_localctx).SYMBOL = match(SYMBOL);
	...
	public final SkipContext skip() throws RecognitionException {
		...
		try {
			...
			{
			setState(88);
			((SkipContext)_localctx).name = name();
			setState(89);
			match(T__3);
			setState(91);
			_la = _input.LA(1);
			if (_la==SYMBOL) {
				{
				setState(90);
				((SkipContext)_localctx).termrightpart = termrightpart();
				}
			}
	...
	public final NameContext name() throws RecognitionException {
		...
		try {
			...
			do {
				...
				{
				setState(109);
				((NameContext)_localctx).SYMBOL = match(SYMBOL);
	...
	public static final String _serializedATN =
		...
		"\2\22\23\7\3\2\2\23\24\5\20\t\2\24\"\7\4\2\2\25\27\7\n\2\2\26\25\3\2\2"+
		"\2\27\30\3\2\2\2\30\31\3\2\2\2\30\26\3\2\2\2\31\32\3\2\2\2\32\35\7\5\2"+
		"\2\33\34\7\n\2\2\34\36\b\2\1\2\35\33\3\2\2\2\36\37\3\2\2\2\37\35\3\2\2"+
		"\2\37 \3\2\2\2 !\3\2\2\2!#\7\4\2\2\"\26\3\2\2\2\"#\3\2\2\2#\'\3\2\2\2"+
		...
		"\2\2\289\5\20\t\29:\7\6\2\2:;\5\b\5\2;<\7\4\2\2<=\b\4\1\2=\7\3\2\2\2>"+
		"?\7\n\2\2?A\b\5\1\2@>\3\2\2\2AB\3\2\2\2B@\3\2\2\2BC\3\2\2\2CD\3\2\2\2"+
		"DE\b\5\1\2E\t\3\2\2\2FK\5\20\t\2GH\7\7\2\2HI\5\f\7\2IJ\b\6\1\2JL\3\2\2"+
		"\2KG\3\2\2\2LM\3\2\2\2MK\3\2\2\2MN\3\2\2\2NO\3\2\2\2OP\7\4\2\2PQ\b\6\1"+
		"\2Q\13\3\2\2\2RS\7\n\2\2SU\b\7\1\2TR\3\2\2\2UV\3\2\2\2VT\3\2\2\2VW\3\2"+
		"\2\2WX\3\2\2\2XY\b\7\1\2Y\r\3\2\2\2Z[\5\20\t\2[]\7\6\2\2\\^\5\b\5\2]\\"+
		"\3\2\2\2]^\3\2\2\2^_\3\2\2\2_a\7\b\2\2`b\7\n\2\2a`\3\2\2\2bc\3\2\2\2c"+
		"d\3\2\2\2ca\3\2\2\2de\3\2\2\2ei\7\t\2\2fh\7\n\2\2gf\3\2\2\2hk\3\2\2\2"+
		"ig\3\2\2\2ij\3\2\2\2jl\3\2\2\2ki\3\2\2\2lm\7\4\2\2mn\b\b\1\2n\17\3\2\2"+
